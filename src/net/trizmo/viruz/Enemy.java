...
//															id			price	damage	health	speed	attackSpeed	currentAttack
	public static final Enemy trojan = new EnemyTrojan(		enemyID++, 	15, 	4, 		2, 		3.0, 	1.5, 		0.0).getTextureFile("trojan");
	public static final Enemy worm = new EnemyWorm(			enemyID++,	30,		7,		6,		2.7,	2.0,		0.0).getTextureFile("worm");
